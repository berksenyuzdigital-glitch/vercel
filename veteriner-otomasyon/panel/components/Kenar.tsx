...
const MENU: { yol: Gorunum; ad: string; ikon: string }[] = [
  { yol: "bugun", ad: "Bugün", ikon: "M3 11l9-8 9 8v9a2 2 0 01-2 2h-4v-6H9v6H5a2 2 0 01-2-2z" },
        ...
        {MENU.map((m) => {
          ...
          return (
            <button
              key={m.yol}
              onClick={() => git(m.yol)}
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-[9px] text-[13.5px] transition-colors text-left"
              style={
                secili
